$(document).ready(function() {
        ...
        $.ajax({
            ...
            success: function(newPost) {
                if (isUpdate) {
                    ...
                    // --- MODIFICATION START ---
                    // Instead of re-fetching, we will manually add the new post to the table.
                    ...
                    // Prepend the new row to the table body and fade it in for a nice effect.
    ...
    // --- Helper function to CANCEL EDIT and reset the form ---
